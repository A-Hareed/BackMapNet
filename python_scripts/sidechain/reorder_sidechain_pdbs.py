...
ATOM_ORDER: Dict[str, Dict[int, List[str]]] = {
    "LYS": {0: ["CB", "CG", "CD"], 1: ["CE", "NZ"]},
    "ALA": {0: ["CB"]},
    "CYS": {0: ["CB", "SG"]},
    ...
    "LEU": {0: ["CB", "CG", "CD1", "CD2"]},
    "THR": {0: ["CB", "OG1", "CG2"]},
    "PHE": {0: ["CB", "CG", "CD1"], 1: ["CE1", "CZ"], 2: ["CD2", "CE2"]},
    "SER": {0: ["CB", "OG"]},
    "PRO": {0: ["CB", "CG", "CD"]},
    "TYR": {0: ["CB", "CG", "CD1"], 1: ["CE1", "CZ", "OH"], 2: ["CE2", "CD2"]},
    "HIS": {0: ["CB", "CG"], 1: ["ND1", "CE1"], 2: ["NE2", "CD2"]},
    "ARG": {0: ["CB", "CG", "CD"], 1: ["NE", "CZ", "NH1", "NH2"]},
    "TRP": {
        0: ["CB", "CG", "CH2"],
        1: ["CD1", "NE1", "CE2"],
        2: ["CZ3", "CZ2"],
