...
- [x] 1LIN  Yet to finish the RDF  Backbone done    {Side chain PDB done}  {target done} {**COMPLETED**}
...
- [ ] 4MT2  DONE Backbone data features    {Side chain PDB done} {Started CG final_feat}  (((SOMETHING BIG WENT WRONG)))))
...
- [x] 1RWH  DONE Backbone data features    {Side chain PDB done} {DONE CG final_feat}  {target done}
- [x] 1TGB  DONE Backbone data features    {Side chain PDB done} {DONE CG final_feat}  {target done}
- [x] 1TIM  DONE Backbone data features    {Side chain PDB done} {DONE CG final_feat}  {target done}
